...
class AmenitiesRepository extends Repository{
    static async getApartmentAmenities(id: number): Promise<string[]>{
    ...
    static async addApartmentAmenity(apartmentId: number, amenity: string){
    ...
    private static async addAmenityIfAbsent(name: string): Promise<number>{
